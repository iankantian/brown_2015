/**
 * Created by joshuabrown on 5/10/16.
 */
            ...
            for( let i = countdown.seconds; i >= 0; i-- ){
                timeoutIds.push( setTimeout( function (){
                    if( countdown.superstitious && i === 13 ){
                        timeoutIds.forEach( clearTimeout ); // this cleverly removes the timeouts!
                        return reject( new Error('not going to say it...'));
                    }
...
const c = new Countdown( 5, true ).on('tick', function( i ){
...
// non trivial addition of timeout to a promise
...
c.go()
    .then( addTimeout( launch, 1000 ))
    .then( function( msg ){
        console.log( msg );
    })
    .catch( function ( derp ){
        console.error( 'Houston we have a problem...', derp.message );
    });
...
//}
//
//const c = new Countdown( 22, true ).on('tick', function( i ){
//    if( i > 0 ) console.log( i + '...' );
//});
//c.go()
//    .then( function(){
//        console.log('fulfilled, GO!');
//    })
//    .catch( function ( derp ){
//        console.error( 'cancelled countdown because', derp.message );
//    });
//
...
//    let now = new Date();
//    if( now.getMinutes() !== start.getMinutes() || ++i > 2 ){
//        return clearInterval( intervalId );
//    }
//    console.log( `${ i }: ${ now }`);
//}, 5000 );
//
//let countdown_length = 10;
//let countdown_running = false;
...
//    }
//    console.log( `${ countdown_length } seconds left!`);
//}, 1000 );
//
